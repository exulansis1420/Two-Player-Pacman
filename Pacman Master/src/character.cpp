...
void Character::init() { 
    ...
    bigpac = NULL;
    temp = IMG_Load("resources/Images/bigpac.png");
    bigpac = SDL_CreateTextureFromSurface(renderer, temp);
    
    bigghost = NULL;
    temp = IMG_Load("resources/Images/bigghost.png");
    bigghost = SDL_CreateTextureFromSurface(renderer, temp);


    font = TTF_OpenFont("resources/Fonts/emulogic.ttf", 25);
    font2 = TTF_OpenFont("resources/Fonts/pac-font 2.ttf",40);
    ...
    menuchange = Mix_LoadWAV( "resources/Sounds/change-menu.wav" );
