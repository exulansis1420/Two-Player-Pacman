...
bool loadMedia()
{
    ...
    if( !gSpriteSheetTexture.loadFromFile( "resources/Images/spritesheet2.png" ) ){
...
bool loadMedia2()
{
    ...
    bool success = true;
    //Load sprite sheet texture
    if( !gSpriteSheetTexture.loadFromFile( "resources/Images/dotspritesheet.png" ) ){
        printf( "Failed to load sprite sheet texture!\n" );
        success = false;
    }
    else{
        ...
        if( !loadMedia() )
            ...
            while( !quit ){
              ...
              //  SDL_RenderPresent( gRenderer );
                if(saveScreenshot("resources/Images/map.png", gRenderer ))
                    break;
